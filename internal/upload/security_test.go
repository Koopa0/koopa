...
//
//nolint:nestif // happy-path vs 400 branches mirror the handler's two legal outcomes; extracting either half loses the adversarial matrix shape
...
func buildMultipartWithField(t *testing.T, fieldName, filename string, data []byte) (body *bytes.Buffer, contentType string) {
	t.Helper()
