...
WHERE (sqlc.narg('status')::collected_status IS NULL OR cd.status = sqlc.narg('status'))
...
VALUES ($1, $2, $3, $4, $5, sqlc.narg('feed_id'), @relevance_score, sqlc.narg('published_at'))
