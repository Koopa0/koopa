...
//
// The per-domain interval (NewDomainLimiter's argument) is the minimum
// spacing between requests to the SAME host; cross-host fetches are
// unlimited here and bounded only by the scheduler's tick cadence.
