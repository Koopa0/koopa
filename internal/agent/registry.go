...
// next restart.
//
// The entries and their capability / schedule choices mirror the seed values
// previously stored in the participant + participant_schedules tables.
// Any change here must be reviewed together with
// docs/architecture/coordination-layer-target.md §11.
func BuiltinAgents() []Agent {
	return []Agent{
		...
		{
			Name:        "koopa0.dev",
			DisplayName: "koopa0.dev",
			Platform:    "claude-code",
			Description: "koopa0.dev development project",
			Capability:  Capability{},
		},
		{
			Name:        "go-spec",
