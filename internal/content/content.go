...
const (
	...
	// TypeNote and TypeBookmark were dropped in the coordination rebuild:
	//   - bookmark → split into the bookmarks table (internal/bookmark)
	//   - note     → collided with Obsidian notes and agent notes; contents
	//                was never the right home for either
)
