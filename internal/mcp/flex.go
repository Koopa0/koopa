...
// See anthropics/claude-code#26027. These types accept both the natural
// JSON shape AND the stringified form so handlers can keep writing
// idiomatic Go.
//
// New tool-input fields that consume numbers or arrays MUST use FlexInt
// and FlexStringSlice respectively. The bare int / []string variants
// are reserved for internal-only struct fields that never cross the MCP
// boundary.
