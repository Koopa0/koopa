...
import (
	...
	"github.com/Koopa0/koopa0.dev/internal/agent/note"
...
type Review struct {
	...
	TasksCompleted  []TaskRef      `json:"tasks_completed"`
...
// TaskRef is a lightweight reference to a completed todo item inside
...
func Compute(
	...
	tasks := make([]TaskRef, len(completed))
