...
## Drill
Not yet performed; `DISASTER-RECOVERY.md` records the runbook as un-rehearsed
since its 2026-06-28 rewrite. Record the date here, with todos / contents /
activity_events row counts compared against production, once one has run.
