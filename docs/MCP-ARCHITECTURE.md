...
| 16a | `learning_dashboard` | view (overview/mastery/weaknesses/retrieval/timeline/variations), domain?, window_days? (mastery defaults 60, others 30), confidence_filter? (mastery/weaknesses only) | view-specific payload | readOnly |
