  ...
  template: `
    ...
    >
      <div class="text-center">
        <div class="mx-auto mb-6 flex size-16 items-center justify-center rounded-full border border-border bg-panel">
          <lucide-icon [img]="AlertTriangleIcon" [size]="32" class="text-fg-subtle" />
        </div>
        <h1 class="text-2xl font-bold text-fg">Something went wrong</h1>
        ...
        <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
          <button
            type="button"
            (click)="reload()"
            class="inline-flex items-center gap-2 rounded-sm bg-white px-5 py-2.5 text-sm font-semibold text-bg transition-colors hover:bg-fg-muted"
          >
