...
describe('KeyboardShortcutsService', () => {
  ...
  describe('admin mode switching', () => {
    ...
    it('should navigate to /admin/atlas when 2 is pressed inside admin', () => {
      setupBrowser('/admin/now');
      dispatchKey('2');
      expect(routerStub.navigate).toHaveBeenCalledWith(['/admin/atlas']);
    });

    it('should NOT switch admin mode from a public route', () => {
