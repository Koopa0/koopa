...
describe('authInterceptor', () => {
  ...
  it('should attach Authorization header when token exists', () => {
    ...
    httpClient.get('/api/admin/knowledge/content').subscribe();

    const req = httpMock.expectOne('/api/admin/knowledge/content');
  ...
  it('should pass through request body unchanged', () => {
    ...
    httpClient.post('/api/admin/knowledge/content', body).subscribe();
