# Angular 21 Best Practices — Project Rules for Gemini
...
Skills are available as native SKILL.md files in `.gemini/skills/`.
Gemini CLI will load them automatically based on task context.
...
To use a skill, Gemini CLI reads `.gemini/skills/{name}/SKILL.md` on demand.
