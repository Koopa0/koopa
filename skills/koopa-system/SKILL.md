...
| [../../docs/audit-verification-protocol.md](../../docs/audit-verification-protocol.md) | 執行 audit / verification / 文件對齊任務前必讀 — 什麼算證據、marker 如何跨 surface 傳播、descriptive/normative 區分 |
