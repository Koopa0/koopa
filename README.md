...
create, delete, or repair the external network lifecycle. Its Compose deployment
legitimately attaches and replaces only its own PostgreSQL endpoint on that
server-owned network.
